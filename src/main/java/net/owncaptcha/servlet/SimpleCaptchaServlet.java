...
import static net.owncaptcha.Captcha.NAME;
...
import net.owncaptcha.backgrounds.GradiatedBackgroundProducer;
import net.owncaptcha.text.renderer.ColoredEdgesWordRenderer;
