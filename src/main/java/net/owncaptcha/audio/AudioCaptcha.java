...
import net.owncaptcha.audio.noise.NoiseProducer;
import net.owncaptcha.audio.noise.RandomNoiseProducer;
import net.owncaptcha.audio.producer.RandomNumberVoiceProducer;
import net.owncaptcha.audio.producer.VoiceProducer;
import net.owncaptcha.text.producer.NumbersAnswerProducer;
import net.owncaptcha.text.producer.TextProducer;
